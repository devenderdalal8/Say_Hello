...
public class ChatActivity extends AppCompatActivity
{
    ...
    private void IntializeControllers()
    {
        ...
        MessageInputText = (EditText) findViewById(R.id.chat_message_input_text);

        messageAdapter = new MessageAdapter(messagesList);
        userMessagesList = (RecyclerView) findViewById(R.id.private_chat_list_of_users);
        userMessagesList.setNestedScrollingEnabled(false); //recycleView free to scroll
        userMessagesList.setHasFixedSize(false);
