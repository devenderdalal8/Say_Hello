...
import com.devender.whatsapp.Fragment.TabAccessorAdapter;
import com.devender.whatsapp.Registration.LoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        myViewPager.setAdapter(new TabAccessorAdapter(getSupportFragmentManager()));
